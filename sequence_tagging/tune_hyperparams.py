...
def get_data():
    ...
    # data_path = '/docker-share/scierc_data/json'
...
def train_mnist(config):
    ...
    m_scores_std_scores = calc_mean_std_scores(data, partial(score_spacycrfsuite_tagger, params=config), splits)
...
if __name__ == "__main__":
    ...
    for trial in trials:
        t =trial.last_result
        print('date: %s; f1-micro: %0.2f; params: %s' % (
        t['date'], t['f1'], json.dumps(t['config'])))